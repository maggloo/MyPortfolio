        ...
        <div className={styles.socialsWrapper}>
            ...
            <div className={styles.navBar}>
                ...
                <div className={`${styles.nav} ${navbarOpen ? ` ${styles.showMenu}` : ""}`}>
                    <Link to="Main" smooth={true} activeClass={styles.active} offset={1} spy={true}
                          onClick={closeMenu}>Main</Link>
                    <Link to="Skills" smooth={true} activeClass={styles.active} offset={1} spy={true}
                          onClick={closeMenu}>Skills</Link>
                    <Link to="Projects" smooth={true} activeClass={styles.active} offset={1} spy={true}
                          onClick={closeMenu}>Projects</Link>
                    <Link to="ContactMe" smooth={true} activeClass={styles.active} offset={1} spy={true}
